...
#1
    ...
    def purchase_ticket_and_seat(self):
        ...
        ticketID = tk.Label(self.purchase_ticket_and_seat, text="ticket id: ")
        ticketID.grid(row =0, column= 0, padx=5, pady=5, sticky="e")
    ...
    def add_person_to_db(self, add_people_page, person_id_entry, first_name_entry, last_name_entry, location_id_dropdown,
        ...
        if not miles and not tax_id:
            messagebox.showerror("Error", "Need to input pilot's tax ID.")
            return
